...
public class MapTaskSpillCompletionEventsUpdate implements Writable {
  TaskCompletionEvent[] events;
  boolean reset;

  public MapTaskSpillCompletionEventsUpdate() { }

  public MapTaskSpillCompletionEventsUpdate(TaskCompletionEvent[] events,
      boolean reset) {
    this.events = events;
    this.reset = reset;
  }
  ...
  public TaskCompletionEvent[] getMapTaskSpillCompletionEvents() {
    return events;
  }
